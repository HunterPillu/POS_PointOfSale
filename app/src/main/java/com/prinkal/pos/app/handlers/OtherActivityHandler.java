...
import com.prinkal.pos.app.activity.LowStockActivity;
...
import com.prinkal.pos.app.helper.ZipManager;
...
import static com.prinkal.pos.app.helper.ZipManager.unzip;
import static com.prinkal.pos.app.helper.ZipManager.zip;

public class OtherActivityHandler {

    private Context context;
    private String backupDBPath = Environment.getExternalStorageDirectory().getPath() + "/Prinkal-Pos-db-backup";
    File ImageDirectory;
