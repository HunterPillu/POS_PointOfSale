...
public class DataBindingAdapters {
    ...
    public static void loadImage(AppCompatImageView view, String imageUrl, Drawable placeHolder, double sizeDevider) {
...
//                break;
    ...
    public static void setEmptyIcon(AppCompatImageView imageview, BundleConstants.EmptyLayoutType pageType) {
        switch (pageType) {
            case CUSTOMER:
