package com.prinkal.pos.app.constants;

import com.prinkal.pos.app.BuildConfig;
...
public interface ApplicationConstants {
    ...
    //    more fragment option ids
    boolean MORE_MENU_CASH_DRAWER_ENABLED = true;
    boolean MORE_MENU_SYNC_WITH_STORE_ENABLED = true;
    boolean MORE_MENU_SALES_AND_REPORTING_ENABLED = true;
    boolean MORE_MENU_MY_ACCOUNT_INFO_ENABLED = true;
    boolean MORE_MENU_CUSTOMERS_ENABLED = true;
    boolean MORE_MENU_CATEGORIES_ENABLED = true;
    boolean MORE_MENU_PRODUCTS_ENABLED = true;
    boolean MORE_MENU_OPTIONS_ENABLED = true;
    boolean MORE_MENU_GIFT_CARD_ENABLED = true;
    boolean MORE_MENU_DISCOUNTS_AND_CART_RULES_ENABLED = true;
    boolean MORE_MENU_TAXES_ENABLED = true;
    boolean MORE_MENU_PAYMENT_METHODS_ENABLED = true;
    boolean MORE_MENU_SHIPPING_METHODS_ENABLED = true;
    boolean MORE_MENU_POS_USERS_ENABLED = true;
    boolean MORE_MENU_USER_ROLES_ENABLED = true;
    ...
    //success message
    String SUCCESS_MSG_1_SIGN_UP = "Welcome to POS App";
